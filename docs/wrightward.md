...
**Version**: 3.11.0 · [Source](https://github.com/Joys-Dawn/toolwright/tree/master/wrightward) · [README](https://github.com/Joys-Dawn/toolwright/blob/master/wrightward/README.md)
...
| `discord.BOT_USER_AGENT` | `DiscordBot (https://github.com/Joys-Dawn/toolwright, 3.11.0)` | Override only with a reason; must start with the literal `DiscordBot` to avoid Cloudflare blocking. |
