...
// Hugging Face cache; transformers.js defaults to this path.
...
// 5GB model download. MINDWRIGHT_USE_STUB_MODELS=1 short-circuits to "cached"
// (stubs never touch disk and have no lazy load, so the gate must pass).
...
// SESSION_ID_PATTERN-gated: session_id flows into a POSIX filesystem path,
// reject anything that would escape dataDir() before join() normalizes it.
