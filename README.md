...
Six [Claude Code](https://docs.anthropic.com/en/docs/claude-code) plugins that can be installed separately or together. All are zero-config — install and start using them immediately.

> 📖 **Full docs:** <https://joys-dawn.github.io/toolwright/> — setup (including Discord bot walkthrough), config reference, MCP tools, hooks, and every option for all six plugins. Start there.
