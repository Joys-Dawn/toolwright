...
async function main() {
  ...
  const server = new Server(
    { name: 'wrightward-bus', version: '3.10.0' },
    {
      capabilities: {
        tools: {},
